...
namespace Renligou.Api.User.Extensions
{
    /// <summary>
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddSwagger(this IServiceCollection services)
        {
            ...
            services.AddOpenApi(options =>
            {
                ...
                {
                    document.Info.Title = "Renligou User API";
                    document.Info.Version = "v1";
                    document.Info.Description = "User接口文档";
            ...
            {
                c.SwaggerDoc("v1", new Microsoft.OpenApi.OpenApiInfo { Title = "Renligou User API", Version = "v1" });
